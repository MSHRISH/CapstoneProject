...
if(!Admin){
    alert("Log in as a Admin!");
    window.location.href="../AccessPages/AdminLogin.html";
}

console.log("Token in LocalStorage: "+Admin.token);

//Token Validation
const decodedToken=jwtRipOpen(Admin.token);
